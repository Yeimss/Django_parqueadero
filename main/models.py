...
class Tarifas(models.Model):
    ...
    fecha=models.DateField(null=False, auto_now=True, auto_now_add=False, verbose_name="Fecha")
    class Meta:
        verbose_name="Tarifa"
...
class Vehiculos(models.Model):
    ...
    fecha_ingreso=models.DateTimeField(null=False, verbose_name="Fecha de ingreso", editable=False, default=timezone.now())
...
""" class VehiclesCeldasDisponibles(Vehiculos):
    objects=ChildVehiculo()
    class Meta:
        proxy=True
        verbose_name="VehiculosConCeldasDisponibles"
